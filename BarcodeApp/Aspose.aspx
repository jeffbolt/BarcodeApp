<%@ Page Title="Barcode" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Aspose.aspx.cs" Inherits="BarcodeApp.BarcodeAspose" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	<script type="text/javascript" src="/Scripts/Barcode.js"></script>

	<h2><%: Title %></h2>
	<h5>Barcode and QR code demos using Aspose.BarCode</h5>
	<h4>Load an exising barcode</h4>
	<div class="tile">
